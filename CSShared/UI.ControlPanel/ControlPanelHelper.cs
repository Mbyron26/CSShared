...
public static class ControlPanelHelper {
    ...
    public static PropertyPanel AddGroup(UIComponent parent, float width, string caption) {
        ...
        Group.EventSetGroupPropertyPanelStyle += (c) => {
            c.Atlas = CustomUIAtlas.CSSharedAtlas;
    ...
    public static CustomUILabel AddMinorLabel(string text) {
        if (Group is null) {
            LogManager.GetLogger().Error("ControlPanelHelper_Group is null");
            return null;
        }
    ...
    public static AlphaSinglePropertyPanel AddButton(string majorText, string minorText, string buttonText, float? buttonWidth, float buttonHeight, Action callback, RectOffset majorOffset = null, RectOffset minorOffset = null) {
        if (Group is null) {
            LogManager.GetLogger().Error("OptionPanelHelper_Group is null.");
            return null;
        }
